...
<footer class="footer">
    <div class="container">
        <div class="row gy-5">
            ...
            <div class="col-lg-4 col-md-6 footer-col">
                ...
                <div class="footer-map">
                    <iframe src="https://www.google.com/maps?q=10.85190287402083,106.74018002793846&z=16&output=embed"
                            loading="lazy"
            ...
            <div class="col-lg-4 col-md-12 footer-col">
                ...
                <div class="footer-subscribe">
                    ...
                    <form class="input-group">
                        <input type="email" class="footer-input form-control" placeholder="Nhập email của bạn">
        ...
        <div class="text-center border-top pt-4 mt-5 border-white-25">
            <p class="text-white-50 mb-0">© <span id="year"><script>document.write(new Date().getFullYear())</script></span> NTC Canteen. Mang món ăn ngon đến bạn.</p>
        </div>
    </div>
</footer>
